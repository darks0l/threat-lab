...
async function main() {
    switch (command) {
            ...
            try {
                ...
                if (patterns.length > 0) {
                    ...
                    for (const m of patterns.slice(0, 3)) {
                        ...
                        console.log(`  ${m.pattern.padEnd(25)} ${bar} ${(m.confidence * 100).toFixed(0)}%`);
            ...
            if (subcommand === 'search') {
                ...
                if (Object.keys(stats.bySeverity).length > 0) {
                    ...
                    for (const [sev, count] of Object.entries(stats.bySeverity)) {
                        console.log(`     ${sev.padEnd(25)} ${count}`);
                    }
                }
                console.log();
            }
        ...
        case 'scan': {
            ...
            const failOnSeverity = failOnIdx !== -1 ? args[failOnIdx + 1] : undefined;
